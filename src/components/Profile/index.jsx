              ...
              <div className="row mt-3">
                <div className="col-md-12">
                  ...
                  <input
                    ...
                    defaultValue={dataUserRedux.user_name}
                  />
                </div>
              ...
              <div className="row mt-3">
                <div className="col-md-12">
                  ...
                  <input
                    ...
                    defaultValue={dataUserRedux.phone}
                  />
                </div>
                ...
                <div className="col-md-12">
                  ...
                  <input
                    type="text"
                    className="form-control"
                    defaultValue={dataUserRedux.gender}
                  />
                </div>
                <div className="col-md-12">
                ...
                <div className="col-md-12">
                  ...
                  <input
                    type="text"
                    className="form-control"
                    defaultValue={dataUserRedux.email}
                  />
                </div>
              </div>
