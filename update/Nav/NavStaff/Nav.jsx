              ...
              <div className="container">
                ...
                <div className="collapse navbar-collapse" id="ftco-nav">
                  <ul className="navbar-nav ml-auto mr-md-3">                                  
                    ...
                    <li className="nav-item"><Link to="/sale" className="nav-link">Sales</Link></li>
                    ...
                    <li className="dropdown nav-item d-md-flex align-items-center">
                      <Link href="/Cart" className="dropdown-toggle nav-link d-flex align-items-center justify-content-center icon-cart p-0" id="dropdown04" >
